                ...
                <div class="grid gap-8 lg:grid-cols-3 max-w-6xl mx-auto">
                    ...
                    <div class="group relative bg-purple-600/5 border border-purple-500/20 p-8 rounded-[2.5rem] transition-all hover:bg-purple-900/10">
                        <div class="space-y-10">
                            ...
                            <div><h3 class="text-2xl font-black italic text-white uppercase tracking-tighter">LIFETIME ACCESS</h3><p class="mt-2 text-[10px] font-bold text-zinc-600 uppercase leading-relaxed">Never generate a key again. Lifetime activation.</p></div>
                            <ul class="space-y-4">
